...
const PortfolioLanding = () => {
    ...
    return (
       ...
       <section id='portfolio-landing' data-testid='portfolio-landing' className="mx-auto flex min-h-screen max-w-7xl flex-col justify-between py-8 px-6 sm:px-10 md:px-8 lg:px-8">
