...
export const SingleProject = ({
  isFirstItem,
  project,
}: { isFirstItem: boolean, project : Project}) => {
  const { t } = useLanguageContext()

  const initialImageIndex = Math.max( 0,
      ...
      <article 
        ...
        <div className={spClassName} >
          ...
          <div className="space-y-4 md:space-y-10 gap-10 col-span-1 md:col-span-3">
            ...
            className="aspect-5/3 overflow-hidden bg-foreground/5 hover:cursor-zoom-in">
              <img
                src={activeImage.src}
                alt={activeImage.alt}
            ...
            <div className="grid grid-cols-4 xl:grid-cols-2 gap-1 border-t border-foreground/15 pt-5 md:pt-10">
              {project.gallery.map((image, index) => {
                ...
                const spBtnClassName = `w-full overflow-hidden transition-opacity hover:opacity-70 hover:cursor-pointer ${
          ...
          {/* <div className=" border-blue-500 border-4 grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 gap-8 xl:grid-cols-[minmax(0,1fr)_180px]"> */}
          <div className="grid sm:grid-cols-1 md:col-span-2 md:grid-cols-5 lg:grid-cols-5 xl:grid-cols-5 2xl:grid-cols-7 gap-2 md:gap-2.5 xl:gap-3.5">
            ...
            <div className="space-y-3 sm:col-span-1 xl:col-span-5 2xl:col-span-2 pt-2 2xl:pt-0">
              ...
              <ul className="flex space-x-1.5 md:flex-col md:space-y-1.5">
