  ...
  items: string[] 
    ...
    return(
        <div key={label} className="border-t border-foreground/15 pt-4">
          {label && <h3 className="mb-4 text-[1.1rem] font-medium leading-none tracking-[-0.04em] text-foreground">
            {label}
          </h3>}
...
const SkillsSection = () => {
  ...
  const { skills, expertise } = locale === "fr" ? { skills: fr.skills, expertise: fr.expertise }  : { skills: en.skills, expertise: en.expertise }
          ...
          <div className="border-t border-foreground/15 flex flex-col gap-8 lg:gap-10">      
            ...
            <div className="grid grid-cols-1 gap-8 lg:grid-cols-[120px_minmax(0,1fr)] lg:gap-x-12">
              ...
              <div className="grid grid-cols-2 gap-x-10 gap-y-12 md:grid-cols-4">
                ...
                <SkillCategory label={skills.programmingLanguages.label}  items={skills.programmingLanguages.items} />
